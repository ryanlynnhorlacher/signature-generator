...
Company.create(name: 'Ryan Horlacher Technologies', front_desk_phone: phones[0], image_link: logo_links.last)
names.each_with_index do |name, index|
Company.create(name: name, front_desk_phone: phones.sample, image_link: logo_links[index])
