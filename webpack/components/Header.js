	...
	return(
		<div className='col-xs-12'>
			...
			<p>
				...
				across departments, divisions, offices and locations. Just enter your information in 
				the form on the left, and your signature will appear inside the box on the right.
			</p>
		</div>
	)
}
